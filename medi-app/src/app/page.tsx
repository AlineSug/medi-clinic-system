    ...
    <div>
      <form className='w-full' onSubmit={authentication}>
        ...
        <div className='w-full py-2'>
          <label htmlFor="" className='text-sm font-bold py-2 block'>User</label>
        ...
        <div className='w-full py-2'>
          <button type="submit" className="w-20 p-2 text-white border-gray-200 border-[1px] rounded-sm bg-green-400">Login</button>
        </div>
        <div>
